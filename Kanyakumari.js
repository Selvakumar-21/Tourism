        ...
        <div className='row'>
            <div className='col' >
                <div className='leftside'>
                    ...
                    <div className= "img1">
                        <img src={require("../images/Kanyakumari.jpeg")} height="100px" alt="" className='img-fluid' />
                    </div>
                </div>
            </div>
            <div className='col'>
        ...
        <div className='container'>
            ...
            <div className='row gy-3'>
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/kanyakumari1 (1).jpeg")} class="card-img-top" alt="Kanyakumari Beach" />
                        <div class="card-body">
                ...
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/kanyakumari1.(2).jpeg")} class="card-img-top" alt="Vivekananda Memorial" />
                        <div class="card-body">
                ...
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/kanyakumari1.(3).jpeg")} class="card-img-top" alt="Marundeeswarar Temple" />
                        <div class="card-body">
                ...
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/kanyakumari1 (4).jpeg")} class="card-img-top" alt="Thirparappu Falls" />
                        <div class="card-body">
