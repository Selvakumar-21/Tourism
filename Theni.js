        ...
        <div className='row'>
            <div className='col' >
                <div className='leftside'>
                    <h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;09.Theni</h2>
                    <div className= "img1">
                        <img src={require("../images/Theni.jpeg")} className="img-fluid"
                        alt="Theni"
        ...
        <div className='container'>
            ...
            <div className='row gy-3'>
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/theni1.(1).jpeg")} class="card-img-top" alt="Chinna Suruli Falls" />
                        <div class="card-body">
                ...
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/theni1 (2).jpeg")} class="card-img-top" alt="Kumbakkarai Falls" />
                        <div class="card-body">
                ...
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/theni1.(3).jpeg")} class="card-img-top" alt="Meghamalai" />
                        <div class="card-body">
                ...
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/theni1.(4).jpeg")} class="card-img-top" alt="Suruli Falls" />
                        <div class="card-body">
