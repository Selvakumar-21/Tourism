        ...
        <div className='row'>
            <div className='col' >
                <div className='leftside'>
                    <h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;02.Rameswaram</h2>
                    <div className= "img1">
                        <img src={require("../images/Rameshwaran.jpeg")} alt="" className='img-fluid' />
                    </div>
                </div>
            </div>
            <div className='col'>
        ...
        <div className='container'>
            ...
            <div className='row gy-3'>
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/rameshwarem1.jpeg")} class="card-img-top" alt="..." />
                        <div class="card-body">
                ...
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/rameshwarem1 (5).jpeg")} class="card-img-top" alt="Lakshmana Temple" />
                        <div class="card-body">
                ...
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/Rameshwaram3..jpeg")} class="card-img-top" alt="Rameshwaram Temple" />
                        <div class="card-body">
                ...
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/rameshwarem1 (6).jpeg")} class="card-img-top" alt="Villoondi Tirtham" />
                        <div class="card-body">
