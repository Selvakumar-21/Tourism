        ...
        <div className='row'>
            <div className='col' >
                <div className='leftside'>
                    <h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;04.Ooty</h2>
                    <div className= "img1">
                        <img src={require("../images/Ooty.jpeg")} className="img-fluid"
                        alt="Ooty"
        ...
        <div className='container'>
            ...
            <div className='row gy-3'>
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/ooty1 (1).jpeg")} class="card-img-top" alt="Nilgiri Mountain Railway" />
                        <div class="card-body">
                ...
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/ooty1 (2).jpeg")} class="card-img-top" alt="Ooty Botanical Garden" />
                        <div class="card-body">
                ...
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/ooty1 (3).jpeg")} class="card-img-top" alt="Emerald Lake" />
                        <div class="card-body">
                ...
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/ooty1 (4).jpeg")} class="card-img-top" alt="Breezy Beach" />
                        <div class="card-body">
