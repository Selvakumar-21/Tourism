...
import "../TimetoVisit/TimetoVisit.css"
...
const FrontPage = () => {
  return (
    <div className='container'>
        ...
        <Row className="">
            <Col md={5}  className="text-right ps-0">
                <img
                    src={require("../../images/Time/Climate.jpeg")}
                    alt="BestTimeToVisit"
                    className="myImage"  
                />
                ...
                <Accordion defaultActiveKey="0" style={{width:"650px"}}>
                    <Accordion.Item eventKey="0">
                        ...
                        <Accordion.Body className='season-text'>
                            ...
                            <img 
                                src={require("../../images/Time/image.jpeg")}
                    ...
                    <Accordion.Item eventKey="1">
                        ...
                        <Accordion.Body className='season-text'>
                            ...
                            <img 
                                src={require("../../images/Time/image1.jpeg")}
                    ...
                    <Accordion.Item eventKey="2">
                        ...
                        <Accordion.Body className='season-text'>
                            ...
                            <img 
                                src={require("../../images/Time/image2.jpeg")}
