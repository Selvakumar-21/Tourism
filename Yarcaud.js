    ...
    <section id='yarcaud'>
        <div className='row'>
            <div className='col' >
                ...
                <   h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;08.Yarcaud</h2>
                    <div className= "img1">
                        <img src={require("../images/Yarcaud.jpeg")} className="img-fluid"
                        alt="Yarcaud"
        ...
        <div className='container'>
            ...
            <div className='row gy-3'>
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/yercaud1.jpeg")} class="card-img-top" alt="Pagoda Point" />
                        <div class="card-body">
                ...
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/yercaud1 (2).jpeg")} class="card-img-top" alt="Botanical Garden" />
                        <div class="card-body">
                ...
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/yercaud1.(3).jpeg")} class="card-img-top" alt="Emerald Lake" />
                        <div class="card-body">
                ...
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/yercaud1 (4).jpeg")} class="card-img-top" alt="Lady,s Seat" />
                        <div class="card-body">
