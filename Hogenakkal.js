        ...
        <div className='row'>
            <div className='col' >
                <div className='leftside'>
                    <h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;10.Hogenakkal</h2>
                    <div className= "img1">
                        <img src={require("../images/Hogenakkal.jpeg")} className="img-fluid"
                        alt="Theni"
        ...
        <div className='container'>
            ...
            <div className='row gy-3'>
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/hogenakkal1.jpeg")} class="card-img-top" alt="Theerthamalai Temple" />
                        <div class="card-body">
                ...
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/hogenakkal2..jpeg")} class="card-img-top" alt="Hogenakkal Falls" />
                        <div class="card-body">
                ...
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/hogenakkal3.jpeg")} class="card-img-top" alt="Pennagram Village" />
                        <div class="card-body">
                ...
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/hokenakkal4..jpeg")} class="card-img-top" alt="Mettur Dam" />
                        <div class="card-body">
