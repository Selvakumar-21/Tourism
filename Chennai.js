        ...
        <div className='row'>
            <div className='col' >
                <div className='leftside'>
                    <h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;01.Chennai</h2>
                    <div className= "img1">
                        <img src={require("../images/Chennai.jpeg")}  className="img-fluid rounded-start"
                        alt="Chennai"
        ...
        <div className='container'>
            ...
            <div className='row gy-3'>
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/chennai1.jpeg")} class="card-img-top" alt="..." />
                        <div class="card-body">
                ...
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/chennai2.jpeg")} class="card-img-top" alt="..." />
                        <div class="card-body">
                ...
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/chennai4.jpeg")} class="card-img-top" alt="Breezy Beach" />
                        <div class="card-body">
