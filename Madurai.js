        ...
        <div className='row'>
            <div className='col' >
                <div className='leftside'>
                    <h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;07.Madurai</h2>
                    <div className= "img1">
                        <img src={require("../images/Madurai.jpeg")} height="100px" alt="" className='img-fluid' />
                    </div>
                </div>
            </div>
            <div className='col'>
        ...
        <div className='container'>
            ...
            <div className='row gy-3'>
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/chennai1.jpeg")} class="card-img-top" alt="Vaigai Dam" />
                        <div class="card-body">
                ...
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/chennai2.jpeg")} class="card-img-top" alt="Meghamalai" />
                        <div class="card-body">
                ...
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/chennai3...jpeg")} class="card-img-top" alt="Marundeeswarar Temple" />
                        <div class="card-body">
                ...
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/chennai4.jpeg")} class="card-img-top" alt="Thirumalai Nayakar" />
                        <div class="card-body">
