        ...
        <div className='row'>
            <div className='col'>
                <div className='leftside'>
                    <h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;03.Kodaikanal</h2>
                    <div className= "img1">
                        <img src={require("../images/Kodaikanal.jpeg")}  className="img-fluid"
                        alt="Kodaikanal"
        ...
        <div className='container'>
            ...
            <div className='row gy-3'>
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/kodaikanal1....jpeg")} class="card-img-top" alt="Green Valley View" />
                        <div class="card-body">
                ...
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/kodaikanal2.jpeg")} class="card-img-top" alt="Kodai Lake" />
                        <div class="card-body">
                ...
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/kodaikanal3..jpeg")} class="card-img-top" alt="Bear Shola Falls" />
                        <div class="card-body">
                ...
                <div className='col-sm-6 col-md-4 col-lg-3'>
                    <div class="card">
                        <img src={require("../images/kodaikanal4.jpeg")} class="card-img-top" alt="Breezy Beach" />
                        <div class="card-body">
