        ...
        <Container>
            <section className='d-flex mt-5 pt-4'>
                <div className='me-5'>
                    ...
                    <p style={{width:'37em',textAlign:'justify',textIndent:'15%'}}>
            ...
            <section className='d-flex mb-5'>
                <div className='p-4 pb-2 border'
                    style={{marginLeft:'6em',width:'29em',borderRadius:'6%',
                ...
                <div className='p-4 pb-2 border'
                    style={{marginLeft:'7em',width:'29em',borderRadius:'6%',
                    boxShadow:'2px 2px 5px 3px gray'}}>
